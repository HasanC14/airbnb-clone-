import { FaMinus, FaPlus, FaStar, FaAngleDown, FaFlag } from "react-icons/fa6";
    ...
    <div>
      <div className="card w-96 bg-base-100 shadow-2xl p-5 border border-gray-300 mt-10">
        ...
        <div className="border border-b-black border-l-black border-r-black rounded-lg pt-3 pb-3">
          ...
          <div
            id="dropdown"
            className="hidden w-full bg-white rounded-lg shadow"
          >
            <ul
      ...
      <div className="flex justify-center items-center mt-10 text-gray-500">
        ...
        <p className="underline"> Report this listing</p>
      </div>
    </div>
  );
};
